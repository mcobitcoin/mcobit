...
const string strMessageMagic = "MCB Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees, int64_t nMoneySupply)
{
    ...
    int64_t nSubsidy = 0;
    int64_t nInitialMoney = 2000000000;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MCB", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "US hits 13 million cases";
        CTransaction txNew;
        txNew.nTime = 1606535219;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xa6538581e61e10f53e7ca78d9c97e235b8d8c9e16a809685e22db6e71cf14a18"));
...
unsigned char pchMessageStart[4] = { 0x6a, 0xbe, 0x33, 0xd8 };
